...
interface ApiService {
    ...
    @POST
    suspend fun postBody(@Url url: String?, @Body object_: Any?) : ResponseBody
    ...
    @POST
    suspend fun putBody(@Url url: String?, @Body object_: Any) : ResponseBody

    @Multipart
    @POST
    suspend fun uploadFlie(@Url fileUrl: String, @Part("description") description: RequestBody, @Part("files") file: MultipartBody.Part
    ) : ResponseBody
