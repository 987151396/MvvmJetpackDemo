...
class WebFragment : BaseFragment<WebViewModel, FragmentWebBinding>() {
    ...
    override fun lazyLoadData() {
        //加载网页
        mAgentWeb = preWeb?.go("http://192.168.33.60:39010/index60.html?game_id=5&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTA3Nzg4MCwidXNlcm5hbWUiOiIxMDc4MjIzIiwiYWdlbnRfaWQiOjAsImV4cCI6MTY1MTIwMzM0NiwiaXNzIjoieW91eGkiLCJuYmYiOjE2NTA1OTc1NDZ9.BuAu-eCqyDSVZjp-aLG10OE1cLL15onjqcz4JWCIBOs&id=1077880&origin=http://192.168.0.84:8099")
